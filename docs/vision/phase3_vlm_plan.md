...
**Why useful for BoneGraph:** Covers cortical bone abnormalities, fractures, and structural changes across multiple bone types with radiologist-validated labels.
...
**Why useful for BoneGraph:** Hand X-rays show cortical thickness, bone density, growth plate status, and skeletal maturity — all relevant to bone morphology understanding.
...
**Why useful for BoneGraph:** Best available public dataset for osteoarthritis progression, knee bone structure, and cartilage loss over time. KL grades (0–4) are provided for osteoarthritis severity.
...
**Why useful for BoneGraph:** Spine CT covers vertebral morphology, fracture detection, and bone density estimation — important for osteoporosis and spinal pathology.
