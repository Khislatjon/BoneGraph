...
- [`../chat/phase2_rag_pipeline.md`](../chat/phase2_rag_pipeline.md) — chunking, embeddings, retrieval, benchmark (MRR 0.928, Recall@5 1.000)
- [`../chat/papers_ingestion_pipeline.md`](../chat/papers_ingestion_pipeline.md) · [`../chat/textbooks_ingestion_pipeline.md`](../chat/textbooks_ingestion_pipeline.md) — the corpus / dataset
